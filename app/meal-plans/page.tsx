        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl font-food font-bold text-gray-900">
              Meal Plans Tailored to Your{" "}
              <span className="text-primary">Health Goals</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              Whether you're managing a health condition, pursuing fitness
              goals, or simply want to eat better, our expert nutritionists have
              crafted meal plans specifically for your needs.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-food font-bold text-gray-900 mb-4">
              Weight Management
            </h2>
            <p className="text-xl text-gray-600">
              Achieve your ideal weight with scientifically-backed meal plans
            </p>
          </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Sustainable weight loss through balanced nutrition
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Healthy weight gain with muscle building focus
                      </p>
                    </div>
                  </div>
                  <div className="space-y-3">
            ...
            {[
              {
                ...
                description:
                  "Blood sugar friendly meals with controlled carbohydrates",
                icon: "🩺",
                price: "$95",
                features: [
                  "Low glycemic index",
              ...
              },
              {
                title: "Heart Health",
                description:
                  "Low sodium, heart-healthy meals for cardiovascular wellness",
                icon: "❤️",
                price: "$92",
                features: [
                  "Low sodium",
              ...
              },
              {
                ...
                description:
                  "Nutrient-dense meals to support recovery and brain health",
                icon: "🧠",
                price: "$98",
                features: [
              ...
              },
              {
                title: "Hypertension",
                description:
                  "Blood pressure friendly meals with natural ingredients",
                icon: "🫀",
                price: "$90",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <div className="relative">
                ...
                <Image
                  ...
                  width={400}
                  height={200}
                  className="w-full h-48 object-cover rounded-t-lg z-20"
                />
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  Nutrition that supports growing minds and bodies
                </p>
                <div className="space-y-2">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  Gentle, nutritious meals for golden years wellness
                </p>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2 text-sm">
                    <Check className="h-4 w-4 text-green-500" />
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow ">
              <div className="relative">
                ...
                <Image
                  ...
                  width={400}
                  height={200}
                  className="w-full h-48 object-cover rounded-t-lg z-10"
                />
                <Badge className="absolute top-4 left-4 bg-primary text-white">
                  All Ages
                </Badge>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  Balance hormones naturally through nutrition
                </p>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2 text-sm">
                    <Check className="h-4 w-4 text-green-500" />
        ...
        <div className="container mx-auto px-4 text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Get a personalized meal plan consultation with our certified
              nutritionists
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-gray-200 px-8 py-4 text-lg"
            >
            ...
            <Button
              size="lg"
              // variant="outline"
              className="bg-transparent border text-white hover:bg-white hover:text-primary px-8 py-4 text-lg"
            >
              View All Plans
            </Button>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-2xl font-food font-bold">
                  Dela Delish
                </span>
              </div>
